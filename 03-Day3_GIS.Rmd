...
<img src="https://images-na.ssl-images-amazon.com/images/I/61jeIyJOAJL.jpg" width="240" align="right" style = "margin-top: -150px; margin-right: 20px">

1. [Database connections](03-Day3_db_connect.html)
1. __GIS & Shapefiles__
1. [Web data](03-Day3_web_data.html)
1. [Tableau](03-Day3_tableau.html)
1. [Other Stats software: SAS, SPSS, MATLAB](03-Day3_other_stats.html)
...
_Ref: [UseR2017 | reading and writing spatial data](https://edzer.github.io/UseR2017/#reading-and-writing-spatial-data)_
...
<i class="fa fa-warning" aria-hidden="true"></i> _Warning:_ When you save UTM coordinates in Excel or R, it's best to switch the columns to text. It will save you you from finding all of your coordinates being rounded by an overly helpful computer.
...
_You've reached the end of the dusty path. You look around and all you see is an old worn scrap of leather. Maybe it used to be a shoe? You can pick it up and take it with you if you like. The choice is all yours really._ 

_Either way, return to the top of the page and continue your adventure._
