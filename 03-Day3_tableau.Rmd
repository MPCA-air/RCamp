...
<img src="http://www.gamebooks.org/gallery/cyoa025.jpg" width="270" align="right" style = "margin-top: -150px; margin-right: 20px">
...
# Tableau
I'll let you in on my best known secret. You can grab data directly from published Tableau workbooks without ever having to open them. This is handy when you don't have access to an underlying database or if you're dealing with a database that requires complicated table joins to extract the data you need. 

Here's the trick:

>  To download data from a Tableau workbook, add ".csv" to the end of a worksheet's _URL_. That's it!
...
Do you feel powerful? Good. But there is one small caveat.
